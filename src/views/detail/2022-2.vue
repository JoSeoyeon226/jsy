...
<head>
    <AppHeader />
    <title>얼굴인식출결시스템</title>   
</head>
<body>
        <div class="page-body">
            <ul id="bca0aac8-6320-434b-855c-3b0dd9a91876" class="bulleted-list">
                <li style="list-style-type:disc">설명 : 2022-1학기 전공과목인 소프트웨어공학의 팀별 프로젝트로 기존 출결 시스템의 취약점을 해결하고자 학생의 얼굴 정보를 인식하여 출결처리 하는 프로그램을 기획</li>
            </ul>
            <ul id="58f8a638-4da9-4af8-b2be-776af300cec8" class="bulleted-list">
                <li style="list-style-type:disc">제작기간 : 22.05.01 ~ 22.06.16(미완성)</li>
            </ul>
            <ul id="73a9e321-ba1c-4e20-9312-73293bb1c6ab" class="bulleted-list">
                <li style="list-style-type:disc">
                    참여인원 및 담당 
                    <p id="68e4999a-b832-4a49-8267-eee738960c86" class="">- 손지은 : 얼굴 인식 및 서버</p>
                    <p id="c3b8bc36-8be4-4fe2-81dd-52173a001f7e" class="">- 임채연 : 얼굴 등록 및 학습</p>
                    <p id="c4ab7080-81f4-4535-b185-5ea9606be9a6" class="">- 조서연 : 페이지 디자인 및 제작</p>
                </li>
            </ul>
            <figure id="1bfb67a8-961d-47b7-8a2e-bae28e1efc27">
                <a href="https://github.com/JoSeoyeon226/Face-recognition" class="bookmark source">
                    <div class="bookmark-info">
                        <div class="bookmark-text">
                            <div class="bookmark-title">GitHub - JoSeoyeon226/Face-recognition: 2022-1학기 소프트웨어공학 프로젝트(얼굴인식 출결인증시스템)</div>
                            <div class="bookmark-description">You can&#x27;t perform that action at this time. You signed in with another tab or window. You signed out in another tab or window. Reload to refresh your session. Reload to refresh your session.</div>
                        </div>
                        <div class="bookmark-href">
                            <img src="https://github.com/favicon.ico" class="icon bookmark-icon"/>
                            https://github.com/JoSeoyeon226/Face-recognition
                        </div>
                    </div>
                    <img src="https://opengraph.githubassets.com/5d2e733acbef5ae4efc3899fef1b736a0204bfc7674597372cf91dd86a7782d3/JoSeoyeon226/Face-recognition" class="bookmark-image"/>
                </a>
            </figure>
            <p id="fc481dca-58a9-4787-b88e-3e863f81a391" class=""></p>
        </div>
</body>
</html>
